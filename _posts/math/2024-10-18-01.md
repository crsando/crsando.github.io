...
$$
    S = \sum_{k=1}^{n} \frac{1}{(k+1) \cdot k^{1/lambda}}
        ...
        = \sum_{k=1}^{n} \big( ( \frac{1}{k} - \frac{1}{k+1} ) 
            \cdot (\frac{1}{k})^{1 - \frac{1}{\lambda}} \big)
        = \sum_{k=1}^{n} \big( ( \frac{1}{k} - \frac{1}{k+1} ) 
            \cdot (\frac{1}{k^{1/\lambda}})^{\lambda - 1} \big)
$$
...
$$
    \frac{1}{k} - \frac{1}{k+1} 
    = g(\frac{1}{k^{1/\lambd}}) - g(\frac{1}{(k+1)^{1/\lambd}}) 
        < g'(\frac{1}{k^{1/\lambda}}) 
            \cdot \big( 
                    \frac{1}{k^{1/\lambd}} - \frac{1}{(k+1)^{1/\lambd}}
                \big)
...
$$
    S = \sum_{k=1}^{n} \frac{1}{(k+1) \cdot k^{1/lambda}}
        ...
        < \sum_{k=1}^{n} 
            ...
            \cdot \big( 
                    \frac{1}{k^{1/\lambd}} - \frac{1}{(k+1)^{1/\lambd}}
            \cdot (\frac{1}{k^{1/\lambda}})^{\lambda - 1}
            \big)
$$