...
引理六：若$L \geqslant x_m \geqslant \lceil \frac{L}{\alpha} \rceil$, 则存在一个对应的 $k \geqslant 0$，使得 $x_{m + 2k} = \lceil \frac{L}{\alpha} \rceil$
...
因此，利用引理6，我们知道存在一个$k \geqslant 0$，使得$x_{u + 2k} = \lceil \frac{L}{\alpha} \rceil$
...
所以，我们可以再次应用引理6，可知必然存在一个$l \geqslant 0$，使得
