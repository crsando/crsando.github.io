...
再由引理2，我们知道 $x_{u+2k+2} = x_{u+2k} - 1 = \lceil \frac{L}{\alpha} \rceil - 1$，
...
$$
    x_{u+2k+3} = \lceil \frac{L}{\alpha} \rceil = x_{u+2k}
$$

则显然有奇数周期3.

若等号不能取得，则我们可以再次应用引理6，可知必然存在一个$l$，使得
