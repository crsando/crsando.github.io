...
这题我们先转化一下，所谓$\Delta a_1$无非是求$a_1$的小数部分，用惯例的写法是$\{a_1\} = a_1 - \lfloor a_1 \rfloor = \Delta a_1$

第一部分，先考虑$a_n$和$k$的对应关系。
...
$$
\begin{aligned}
    \min_{k\in Z^+} f = f(\lfloor \frac{\sqrt{n+1} + 1}{2} \rfloor)
\end{aligned}
$$
